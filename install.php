<?php
	if (!file_exists("./private"))
	{
		...
		$set_products[] = array('ref' => "Florian", 'category' => "Garçon", 'price' => 5, 'stock' => 99999, 'img' => "flbeaumo");
		$set_products[] = array('ref' => "Anne", 'category' => "Fille", 'price' => 2, 'stock' => 9999, 'img' => "aquan");
